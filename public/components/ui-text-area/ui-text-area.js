class UITextArea extends Polymer.Element {
    ...
    changed(event, a, b, c) {
        ...
        if (id === '' && strClass === '') {
            EventBroker.trigger(id + "_ui-text-area_changed", {UITextArea: this, textArea: textArea, validation: validation, event: event, tableRow: tableRow});
        } else {
            if (id !== '') {
                EventBroker.trigger(id + "_ui-text-area_changed", {UITextArea: this, textArea: textArea, validation: validation, event: event, tableRow: tableRow});
            }
            if (strClass !== '') {
                EventBroker.trigger(strClass + "_ui-text-area_changed", {UITextArea: this, textArea: textArea, validation: validation, event: event, tableRow: tableRow});
            }
        }
    }
