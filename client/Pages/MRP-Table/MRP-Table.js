...
Template.MRPTable.onRendered(function () {
    ...
    tableData3.push(['Order Date', 'Region', 'Rep', 'Total']);
    ...
    tableData5.push(['Order Date', 'Region', 'Rep', 'Web Page']);
    ...
    tableData4.push(['Order Date', 'Region', 'Rep', 'Actions']);
    ...
    tableData2.push(['#', 'Order Date', 'Region', 'Rep', 'Total']);
    ...
    tableData6.push(['#', 'Order Date', 'Region', 'Rep', 'Total']);
...
buildListeners = function (id, description) {
    EventBroker.listen(id + "_mrp-table_clicked", function (listenerArgs, triggerArgs) {
        console.log('The ' + description + ' Table was clicked');
        console.log(triggerArgs);
    });

    EventBroker.listen(id + "_mrp-table_dblclicked", function (listenerArgs, triggerArgs) {
        console.log('The ' + description + ' Table was double clicked');
        console.log(triggerArgs);
    });
}

buildListeners('basicTable', 'Basic');
buildListeners('footerTable', 'Footer');
buildListeners('sotrTable', 'Sort');
buildListeners('searchTable', 'Search');
buildListeners('buttonTable', 'Button');
buildListeners('pagedTable', 'Pages');
buildListeners('selectTable', 'Select');
buildListeners('objectTable', 'Object');
buildListeners('cellButtonTable', 'Cell Buttons');
buildListeners('linkTable', 'Links');
buildListeners('everythingTable', 'Everything');
